...
public class MyPandasDemo {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		mydf = mypanda.readCSV("state_all3.csv");		
		...
		mypanda.writeCSV(mydf.head(5), "head_5.csv");
...
//		mypandaDemo.separateLine("Test case of MyDataFrame slice(0) Returns the column specified by index.");	
//		System.out.println(mydf.slice(0));
//		
...
//		System.out.println(mydf.slice([0,1]));
		...
		System.out.println(mydf.loc("14"));
		System.out.println(mydf.loc("3","6"));
